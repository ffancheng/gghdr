...
StatHdrcde <- ggproto("StatHdrcde", Stat,
                      ...
                      compute_group = function(data, scales, width = NULL, probs = NULL, nxmargin = nxmargin, all.modes = TRUE, na.rm = FALSE) {
                        ...
                        if(!all(data$x == data$x[1])){
                          ...
                          hdrcde_est <- hdrcde::cde(data$x, data$y, nxmargin = nxmargin)
